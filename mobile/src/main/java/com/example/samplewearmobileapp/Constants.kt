...
object Constants {
    ...
    const val PREF_TREE_URI = "treeUri"
    const val PREF_PATIENT_NAME = "patientName"
    const val PREF_PPG_GREEN_VISIBILITY = "ppgGreenVisibility"
    const val PREF_PPG_IR_VISIBILITY = "ppgIrVisibility"
    const val PREF_PPG_RED_VISIBILITY = "ppgRedVisibility"
    const val PREF_ECG_VISIBILITY = "ecgVisibility"
    const val PREF_ANALYSIS_VISIBILITY = "analysisVisibility"
     ...
     */
    val N_SMALL_BOXES_PER_LARGE_BOX = 5
     ...
     */
    val A_DERIVATIVE = doubleArrayOf(12.0)
    val B_DERIVATIVE = doubleArrayOf(25.0, -48.0, 36.0, -16.0, 3.0)
